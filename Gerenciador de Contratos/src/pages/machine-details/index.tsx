                  ...
                  <div className="grid grid-cols-1 md:flex justify-center items-center m-2">
                    {machine?.disponivelaluguel === "Sim" ? (
                      <Button
                        className="m-2"
                        onClick={() => {
                          navigate(`/rent-machine/${machine.idpublico}`);
                        }}
                      >
                        Alugar máquina
                      </Button>
                      ...
                      <Button disabled={true}>
                        Máquina indisponível para aluguel
                      </Button>
                    )}
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription style={{ color: "hsl(var(--text))" }}>
                  Você precisa estar logado pra fazer isso, por favor entre na
                  sua conta.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
