...
const RentMachine = () => {
    ...
    const loadMachineOwnerAddress = async () => {
      if (machineOwnerId) {
        try {
          ...
          setError(true);
          setErrorMessage(
            "Houve um erro ao carregar o endereço do locador da máquina.",
          );
        }
      }
    };
  ...
  useEffect(() => {
    const loadAddress = async (id: string) => {
      try {
        ...
        setError(true);
        setErrorMessage(
          "Houve um erro ao carregar seu endereço. Acesse seu perfil para verificar.",
        );
        setStep("cadastro-locatario");
      }
    };
  ...
  const tryCreateRenter = async () => {
    ...
    try {
      const createdRenterId = await createRenter(
        user.idusuario,
        address.idendereco,
      );
            ...
            "Houve um erro ao carregar seu endereço. Acesse seu perfil para verificar." ? (
              <div>
                <p className="text-[black]">
                  Houve um erro ao carregar as informações. Reporte o problema
                  aqui:
                </p>
        ...
        {step === "cadastro-locatario" ? (
          <div className="rent-machine-container">
            <Card className="bg-[hsl(var(--machine-card-bg))] w-full md:w-[60vw] m-4 border-[hsl(var(--primary))]">
              ...
              <CardDescription>
                <p>
                  Confirme seus dados antes de alugar a máquina. Só é necessário
                  realizar esse processo uma vez.
                </p>
                <p>
                  Se precisar atualizar alguma informação, acesse o seu perfil.
                </p>
              </CardDescription>
              <CardContent className="flex flex-col items-center w-full p-4">
                <Card className="w-full md:w-[80%] mt-2 bg-[hsl(var(--machine-card-bg))] pb-4 border-[hsl(var(--primary))] p-4">
                  ...
                  <Label className="text-[hsl(var(--text))] mt-2">
                    Documento
                  </Label>
                  <Input
              ...
              <CardFooter className="flex justify-center">
                {address && user && (
                  <Button onClick={tryCreateRenter}>
          ...
          <div className="rent-machine-container">
            <Card className="bg-[hsl(var(--machine-card-bg))] w-full md:w-[60%] m-4 border-[hsl(var(--primary))]">
              ...
              <CardDescription>
                <p>
                  Revises essas informações antes de alugar a máquina. Role para
                  baixo para ver mais e leia com atenção.
                </p>
                <p>
                  Se precisar atualizar alguma informação, acesse o seu perfil.
                </p>
              ...
              <CardContent className="flex flex-col items-center w-full">
                <Card className="w-full md:w-[80%] mt-2 bg-[hsl(var(--machine-card-bg))] pb-4 border-[hsl(var(--primary))]">
                  ...
                  {machine && (
                    <CardContent>
                      <Label className="text-[hsl(var(--text))] mt-2 mb-2">
                        Nome da Máquina
                      </Label>
                      <Input
                        value={machine?.nome}
                ...
                <Card className="w-full md:w-[80%] mt-2 bg-[hsl(var(--machine-card-bg))] pb-4 border-[hsl(var(--primary))]">
                  ...
                  <CardContent>
                    ...
                    <Label className="text-[hsl(var(--text))] mt-2 mb-2">
                      Prazo do Aluguel (em {medidaPrazo})
                    </Label>
                    <Input
                      value={prazo}
                      type="number"
                    ...
                    />
                    <p className="mt-2">
                      Foi adicionada uma taxa de 5% do valor mensal da máquina
                ...
                <Card className="w-full md:w-[80%] mt-2 bg-[hsl(var(--machine-card-bg))] pb-4 border-[hsl(var(--primary))]">
                  <CardHeader className="text-[hsl(var(--text))] text-[1.25rem]">
                    <strong>Informações para Pagamento</strong>
                  </CardHeader>
                  <CardContent>
                    <Label className="text-[hsl(var(--text))] mt-2 mb-2">
                ...
                >
                  {sendingRequest
                    ? "Solicitando..."
                    : "Solicitar o aluguel da máquina"}
                </Button>
                <CardDescription>
                  <p className="text-[hsl(var(--text))]">
                    O dono da máquina vai receber uma notificação e poderá
                    aprovar o aluguel da máquina.
                  </p>
                </CardDescription>
              </CardContent>
            </Card>
