...
import "@/components/update-machine/update-machine.css";
...
export default function UpdateMachine() {
  ...
  return (
    <Layout>
      <div className="container-maquinas-update">
        <Card className="form-maquinas-update border-[hsl(var(--primary))] mt-10 ml-2 mr-2 w-[98vw] max-w-3xl mb-10">
          <CardHeader>
            <h2 className="text-[25px] text-[hsl(var(--text))]">
              Atualização de Máquina
            </h2>
          </CardHeader>
          <CardContent className="form-content-update space-y-4">
            <CardDescription>
              <Label className="mb-1">Imagem Principal</Label>
              <div className="machine-image-update">
                {loadingImage ? (
                  <div>
                  ...
                  <img
                    src={image}
                    className="p-0 w-full mb-4"
                    alt={`Imagem de ${machine?.nome}`}
                  />
                ) : (
                  <div className="image-placeholder-update">Imagem indisponível</div>
                )}
              </div>

              <Label htmlFor="machine-name-update" className="mb-1">
                Nome da Máquina
              </Label>
              <Input
                id="machine-name-update"
              ...
              <select
                ...
                className="w-[455px] bg-[hsl(var(--background))] h-[30px] text-[hsl(var(--text))] mb-4 border-[hsl(var(--primary))] rounded-m border-[1px]"
              ...
              <EquipmentSelect className="text-[hsl(var(--text))] bg-[hsl(var(--background))] mb-4 border-[hsl(var(--primary))] rounded-m border-[1px] w-full" onChange={(e) => setCategory(e.target.value)} />

              <div className="button-group-maquinas-update flex gap-4 mt-6">
